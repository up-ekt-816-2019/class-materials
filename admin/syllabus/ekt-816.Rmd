...
## `r advdate(mon, 8)`: Selection Models (Part II); Marginal Treatment Effects, LATE, and "Monotonicity"
...
## `r advdate(mon, 9)`: Applications; MTEs and LATE in Practice
...
## `r advdate(mon, 10)`: Synthetic Panels and Diff-in-Diff
...
## `r advdate(mon, 11)`: Individual-Level Panel Data (Part I)
...
## `r advdate(mon, 12)`: Individual-Level Panel Data, Part II - Mover Designs
...
## `r advdate(mon, 13)`: Individual-Level Panel Data, Part III - Event Studies
