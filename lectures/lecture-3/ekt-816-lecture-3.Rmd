...
- the term $E[Y^1|D = 0]  - E[Y^0|D = 0]$ is called "selection bias"
...
- this is actually two assumptions
    ...
    - potential outcomes for a given individual don't depend on the way treatment was assigned
        ...
        - may be able to get around some of these problems by observing other outcomes to use as instruments
